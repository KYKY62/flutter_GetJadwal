...
import 'package:flutter_getjadwal/controller/edit_controller.dart';
import 'package:flutter_getjadwal/utils/add_schedule_dialog.dart';
import 'package:flutter_getjadwal/utils/delete_dialog.dart';
import 'package:flutter_getjadwal/utils/edit_schedule_dialog.dart';
...
class DetailJadwal extends StatelessWidget {
  ...
  final cUpdate = Get.put(EditController());
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            GestureDetector(
                              onTap: () async {
                                EditScheduleDialog.editSceduleDialog(
                                  context: context,
                                  courseController: cAdd.course,
                                  value: cAdd.selectedValue.value,
                                  onTap: () {
                                    EditController().editSchedule(
